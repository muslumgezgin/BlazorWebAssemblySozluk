...
public interface IGenericRepository<TEntity> where TEntity : BaseEntity
{
    ...
    Task<TEntity> GetSingleAsync(Expression<Func<TEntity, bool>> predicate, bool noTrackin = true, params Expression<Func<TEntity, object>>[] includes);

    Task<TEntity> FirstOrDefaultAsync(Expression<Func<TEntity, bool>> predicate, bool noTrackin = true, params Expression<Func<TEntity, object>>[] includes);

    IQueryable<TEntity> Get(Expression<Func<TEntity, bool>> predicate, bool noTrackin = true, params Expression<Func<TEntity, object>>[] includes);
